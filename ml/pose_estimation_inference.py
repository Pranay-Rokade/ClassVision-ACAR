...
# Data pipeline to classify multiple students at a time using pose estimation
def activity_recognition():
    """This function provides the data pipeline to classify multiple students actions at the same time"""
